...
@section('content')
    ...
    @endif
    <a href="{{ route('crud.create') }}" class="btn btn-outline-primary btn-sm m-0 waves-effect"><i class="fas fa-user-plus"></i> <b>Tambah Data</b></a><br><hr>
...
<td>
<center><a href="{{route('crud.show', $c['kode'])}}" class="btn btn-light"><i class="fas fa-eye"></i> Lihat</a> <a href="{{route('crud.edit',$c['kode'])}}" class="btn btn-warning"><i class="fas fa-user-edit"></i> Edit</a>

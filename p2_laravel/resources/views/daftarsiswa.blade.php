...
<body>
    <div class="container">
        <div style="margin-top: 20px ">
            <div class="row">
                <div class="col-md-4">
                    {{-- <a href="/daftar-siswa" class="btn btn-primary btn-sm">Tampil Semua</a> --}}
                    <form action="{{url('daftarsiswa/')}}" method="GET">
                        ...
                        <div class="form-group">
                            ...
                            <a href="/daftarsiswa" class="btn btn-primary btn-sm">Lihat Semua</a>
                        </div>
                    </form>
